...
# Safe pile load carrying capacity (T) for 0.3m diameter
compression_03 = borehole_data["Compression Capacity (Ton)"].values  # Example function
lateral_03 = 0.5 + 0.6 * (pile_depth - pile_depth_start)
tension_03 = 0.4 + 0.5 * (pile_depth - pile_depth_start)
